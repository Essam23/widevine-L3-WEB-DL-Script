...
print("by parnex")
print("Required files : mkvmerge.exe, mp4decrypt.exe, m3u8DL.exe, aria2c.exe\n")
...
m3u8DLexe = dirPath + '/binaries/m3u8DL.exe'
...
subprocess.run([m3u8DLexe, mpd_url, '--enableDelAfterDone', '--enableMuxFastStart', '--workDir', dirPath, '--saveName', 'encrypted'])
